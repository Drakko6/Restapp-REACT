...
export default function AddReviewRestaurant(props){
    ...
    const {idRestaurant, setReviewsReload} = props.route.params;
       ...
       if(rating === null){
           toastRef.current.show("No has dado ninguna puntuación");
            ...
            db.collection("reviews").add(payload).then(()=>{
                ...
                toastRef.current.show("Error al enviar el comentario. Intente más tarde");
                setIsLoading(false);
            })
    ...
    return(
        <View style={styles.viewBody}>
            ...
            <AirbnbRating 
                count={5}
                reviews={[ "Pésimo", "Deficiente", "Regular", "Bueno", "Excelente"]}  
                defaultRating={0}
                size={35}
